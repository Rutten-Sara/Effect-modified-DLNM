...
model_laplace_common <- DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                         crossbasis = crossbasis,
                                         ID = as.factor(datafull$city_name),
                                         covar.ri = "ind",
                                         smooth = datafull$date,
                                         df_smooth = 7*length(unique(datafull$year)),
                                         smooth2 = datafull$dpv_scaled,
                                         df_smooth2 = 10,
                                         offset = datafull$pop,
                                         data = datafull, 
                                         type = "none",
...
model_laplace_common_quantile <- DLNM_Laplace_cov(y_all ~  dow + prop_65p,
...
model_laplace_common_NB <- DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                            crossbasis = crossbasis,
                                            ID = as.factor(datafull$city_name),
                                            covar.ri = "ind",
                                            smooth = datafull$date,
...
model_laplace_common_quantile_NB <- DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                                     crossbasis = crossbasis_quantiles,
                                                     ID = as.factor(datafull$city_name),
                                                     covar.ri = "ind",
                                                     smooth = datafull$date,
...
model_laplace_inter <-  DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                   crossbasis = crossbasis,
                                   ID = as.factor(datafull$city_name),
                                   covar.ri = "ind",
                                   smooth = datafull$date,
...
model_laplace_inter_quantile <-  DLNM_Laplace_cov(y_all ~  dow  + prop_65p,
                                   crossbasis = crossbasis_quantiles,
                                   ID = as.factor(datafull$city_name),
                                   covar.ri = "ind",
                                   smooth = datafull$date,
...
model_laplace_inter_NB <-  DLNM_Laplace_cov(y_all ~  dow  + prop_65p,
                                         crossbasis = crossbasis,
                                         ID = as.factor(datafull$city_name),
                                         covar.ri = "ind",
                                         smooth = datafull$date,
...
model_laplace_inter_quantile_NB <-  DLNM_Laplace_cov(y_all ~  dow  + prop_65p,
                                                  crossbasis = crossbasis_quantiles,
                                                  ID = as.factor(datafull$city_name),
                                                  covar.ri = "ind",
                                                  smooth = datafull$date,
...
model_laplace_linear <-  DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                   crossbasis = crossbasis,
                                   ID = as.factor(datafull$city_name),
                                   covar.ri = "ind",
                                   smooth = datafull$date,
...
model_laplace_linear_quantile <-  DLNM_Laplace_cov(y_all ~  dow  + prop_65p,
                                          crossbasis = crossbasis_quantiles,
                                          ID = as.factor(datafull$city_name),
                                          covar.ri = "ind",
                                          smooth = datafull$date,
...
model_laplace_linear_NB <-  DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                          crossbasis = crossbasis,
                                          ID = as.factor(datafull$city_name),
                                          covar.ri = "ind",
                                          smooth = datafull$date,
...
model_laplace_linear_quantile_NB <-  DLNM_Laplace_cov(y_all ~  dow + prop_65p,
                                                   crossbasis = crossbasis_quantiles,
                                                   ID = as.factor(datafull$city_name),
                                                   covar.ri = "ind",
                                                   smooth = datafull$date,
...
model_laplace_binary <- DLNM_Laplace_cov(y_all ~  dow + prop_65p ,
                                         crossbasis = crossbasis,
                                         ID = as.factor(datafull$city_name),
                                         covar.ri = "ind",
                                         smooth = datafull$date,
...
model_laplace_binary_quantile <- DLNM_Laplace_cov(y_all ~  dow + prop_65p ,
                                         crossbasis = crossbasis_quantiles,
                                         ID = as.factor(datafull$city_name),
                                         covar.ri = "ind",
                                         smooth = datafull$date,
...
model_laplace_binary_NB <- DLNM_Laplace_cov(y_all ~  dow + prop_65p ,
                                         crossbasis = crossbasis,
                                         ID = as.factor(datafull$city_name),
                                         covar.ri = "ind",
                                         smooth = datafull$date,
...
model_laplace_binary_quantile_NB <- DLNM_Laplace_cov(y_all ~  dow +prop_65p ,
                                                  crossbasis = crossbasis_quantiles,
                                                  ID = as.factor(datafull$city_name),
                                                  covar.ri = "ind",
                                                  smooth = datafull$date,
